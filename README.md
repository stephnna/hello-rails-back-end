...
<div align="center">
  <img width="700" src="hello-rails-back-end.gif" />
</div>
...
This projects aim is to implememnt a project that allows for a connection between a Ruby on Rails back-end and React front-end.
...
#### Github
- Enter this url: [https://github.com/stephnna/hello-rails-back-end](https://github.com/stephnna/hello-rails-back-end) in your web browser.
...
```sh
  git clone git@github.com:stephnna/hello-rails-back-end.git
